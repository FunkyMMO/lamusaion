...
public enum CustomMessageId {
  WELCOME_PREMIUM(
    "Welcome Premium Member to %s server.\nPowered by " +
    getMaster() +
    ".\nSERVER RATES:\nExp Rate: %d\nQuest Rate: %d\nDrop Rate: %d"
  ),
  WELCOME_REGULAR(
  ...
  INFO1(
    "WARNING: Using of third-party software (speed hack&Co.) will be punished with permanent ban (Ban MAC)"
  ),
  INFO2(
    "Note: Likewise, hacking will result in an immediate ban regardless of reasons behind it."
  ),
  INFO3(
    "Note: The advertising for other servers is prohibited.Breaking this rule will result a permanent ban!"
  ),
  INFO4("Note: Our team will never ask you for your account password!"),
  INFO5(
    "Chat: Use .faction, .ely, .asmo <text>, to write in your faction World chat."
  ),
  ...
  COMMAND_ADDDROP_SYNTAX(
    "Syntax: //adddrop <mob id> <item id> <min> <max> <chance>"
  ),
  ...
  COMMAND_ADDSKILL_ADMIN_SUCCESS(
    "Skill %d was added to player %s with success"
  ),
  COMMAND_ADDSKILL_PLAYER_SUCCESS("%s gave you a new skill"),
  COMMAND_ADDTITLE_SYNTAX(
    "Syntax: //addtitle <title id> <player name> [special]"
  ),
  COMMAND_ADDTITLE_TITLE_INVALID(
    "Title %d is invalid, it must be between 1 and 50"
  ),
  ...
  COMMAND_ADDTITLE_ADMIN_SUCCESS_ME(
    "You added title %d to yourself with success"
  ),
  ...
  COMMAND_DELSKILL_ADMIN_SUCCESS(
    "Skill %d was deleted from player %s with success"
  ),
  COMMAND_DELSKILL_PLAYER_SUCCESS("%s removed from you Skill %d"),
  CHANNEL_WORLD_DISABLED(
    "The channel %s is disabled, please use channel %s or %s according to your faction"
  ),
  ...
  CHANNEL_BANNED(
    "You can't use chat channels because %s banned you for following reason: %s, remaining time: %s"
  ),
  COMMAND_MISSING_SKILLS_STIGMAS_ADDED(
    "%d basic skills and %d stigma skills has been added to you"
  ),
  ...
  COMMAND_XP_DISABLED(
    "Your experience gain has been disabled. Type .xpon to re-enable"
  ),
  ...
  COMMAND_ADDCUBE_ADMIN_SUCCESS(
    "9 cube slots successfully added to player %s!"
  ),
  COMMAND_ADDCUBE_PLAYER_SUCCESS("Admin %s gave you a cube expansion!"),
  COMMAND_ADDCUBE_FAILURE(
    "Cube expansion cannot be added to %s!\nReason: player cube already fully expanded."
  ),
   ...
   */
  ASMO_FAIL(
    "You are Elyos! You can't use this chat. Please use .ely <message> to use you're faction chat!"
  ),
  ELY_FAIL(
    "You are Asmo! You can't use this chat. Please use .asmo <message> to use you're faction chat!"
  ),
  /**
   * PvP Service
   */
  ...
  ENCHANT_INFO(
    " Info: This command enchant all your equiped items to <value>!"
  ),
  ENCHANT_SAMPLE(
    " Sample: (.eq 15) would enchant all your equiped items to 15"
  ),
  /**
   * Userinfo Command
   */
  ...
  BATTLEGROUND_MESSAGE3(
    "The Battleground: %s is now ready to start. You will be teleported in 30 seconds."
  ),
  ...
  BATTLEGROUND_MESSAGE17(
    "Use the command .bg unregister to cancel your registration."
  ),
  BATTLEGROUNDMANAGER_MESSAGE1("Only group leader can register group."),
  BATTLEGROUNDMANAGER_MESSAGE2(
    "You are now registered for the battleground: %s"
  ),
  BATTLEGROUNDMANAGER_MESSAGE3(
    "Please wait while your team is in formation..."
  ),
  BATTLEGROUNDMANAGER_MESSAGE4("All members can't join this battleground."),
  BATTLEGROUNDMANAGER_MESSAGE5(
    "You are too many to register in this battleground now."
  ),
  BATTLEGROUNDMANAGER_MESSAGE6(
    "You are now registered for the battleground:%s"
  ),
  BATTLEGROUNDMANAGER_MESSAGE7(
    "Please wait while your team is in formation..."
  ),
  BATTLEGROUNDMANAGER_MESSAGE8("All members can't join this battleground."),
  BATTLEGROUNDMANAGER_MESSAGE9(
    "You are too many to register in this battleground now."
  ),
  BATTLEGROUNDMANAGER_MESSAGE10(
    "Some members are already registered in a battleground."
  ),
  BATTLEGROUNDMANAGER_MESSAGE11(
    "You are now registered for the battleground: %s"
  ),
  BATTLEGROUNDMANAGER_MESSAGE12(
    "Please wait while your team is in formation..."
  ),
  BATTLEGROUNDMANAGER_MESSAGE13(
    "You are now registered to observe the battleground: %s"
  ),
  BATTLEGROUNDMANAGER_MESSAGE14(
    "Please wait until the battleground is full..."
  ),
  BATTLEGROUNDMANAGER_MESSAGE15(
    "No battleground available for you with your level and your battleground points."
  ),
  BATTLEGROUNDMANAGER_MESSAGE16("Register to battlegrounds"),
  BATTLEGROUNDMANAGER_MESSAGE016(
  ...
  BATTLEGROUNDMANAGER_MESSAGE018(
    "You can register for the following battlegrounds :"
  ),
  BATTLEGROUNDHEALERCONTROLLER_1(
    "You were alone in the battleground, you have been teleported back."
  ),
  BATTLEGROUNDHEALERCONTROLLER_2(
    "You were alone in the battleground, you have been teleported back."
  ),
  BATTLEGROUNDAGENTCONTROLLER_1(
    "You are already registered in a battleground."
  ),
  BATTLEGROUNDFLAGCONTROLLER_2("unhandled case."),
  BATTLEGROUNDFLAGCONTROLLER_3("Do you want to register in a battleground ?"),

  COMMAND_BATTLEGROUND_MESSAGE0(
    "You cannot register for battlegrounds while you are in prison."
  ),
  COMMAND_BATTLEGROUND_MESSAGE1("You are already in a battleground."),
  COMMAND_BATTLEGROUND_MESSAGE2(
    "Use your spell Return to leave the battleground."
  ),
  COMMAND_BATTLEGROUND_MESSAGE3(
    "You are already registered in a battleground."
  ),
  COMMAND_BATTLEGROUND_MESSAGE4(
    "Use the command .bg unregister to cancel your registration."
  ),
  COMMAND_BATTLEGROUND_MESSAGE5(
    "You are already registered in the Arena Team waiting list."
  ),
  COMMAND_BATTLEGROUND_MESSAGE6(
    "Use the command .arena to cancel your registration."
  ),
  COMMAND_BATTLEGROUND_MESSAGE7(
    "You are already registered in the Arena Team waiting list."
  ),
  COMMAND_BATTLEGROUND_MESSAGE8(
    "Use your spell Return to leave the Arena Team Battle."
  ),
  COMMAND_BATTLEGROUND_MESSAGE9("You are already in a battleground."),
  COMMAND_BATTLEGROUND_MESSAGE10(
    "Use your spell Return to leave the battleground."
  ),
  COMMAND_BATTLEGROUND_MESSAGE11(
    "You are already registered in a battleground."
  ),
  COMMAND_BATTLEGROUND_MESSAGE12(
    "Use the command .bg unregister to cancel your registration."
  ),
  COMMAND_BATTLEGROUND_MESSAGE13(
    "You are playing in a battleground, not an observer."
  ),
  ...
  COMMAND_BATTLEGROUND_MESSAGE18(
    "You are not registered in any battleground or the battleground is over."
  ),
  COMMAND_BATTLEGROUND_MESSAGE19("The exchange tool is not available."),
  COMMAND_BATTLEGROUND_MESSAGE20(
    "The exchange rate is 1 BG point for 3 Abyss points."
  ),
  COMMAND_BATTLEGROUND_MESSAGE21(
    "To exchange some points, write .bg exchange <bg_points_number>"
  ),
  COMMAND_BATTLEGROUND_MESSAGE22("You don't have enough BG points."),
  COMMAND_BATTLEGROUND_MESSAGE23("You have lost %d BG points."),
  COMMAND_BATTLEGROUND_MESSAGE24(
    "Syntax error. Use .bg exchange <bg_points_number>."
  ),
  ...
  COMMAND_BATTLEGROUND_MESSAGE29(
    ".bg unregister : unregister from the BG (before starting)"
  ),
   ...
   */
  LEGENDARY_RAID_SPAWNED_ASMO(
    "[Legendary Raid Spawn Event] Ragnarok was spawned for Asmodians at Beluslan!"
  ),
  LEGENDARY_RAID_SPAWNED_ELYOS(
    "[Legendary Raid Spawn Event] Omega was spawned for Elyos at Heiron!"
  ),
  LEGENDARY_RAID_DESPAWNED_ASMO(
    "[Legendary Raid Spawn Event] Ragnarok was unspawned, nobody kill him!"
  ),
  LEGENDARY_RAID_DESPAWNED_ELYOS(
    "[Legendary Raid Spawn Event] Omega was unspawned, nobody kill him!"
  ),
   ...
   */
  GUARDIAND_SHOWDOWN_SPAWN(
    "[Event] The Guardian General Showdown is now started"
  ),
  GUARDIAND_SHOWDOWN_DESPAWN(
    "[Event] The Guardian General Showdown is now finished"
  ),
  /**
   * Invasion Rift
   */
  ...
  DECOMPOSE_SERVICE_MESSAGE2(
    "%s has obtained additional %s from %s (Premium)."
  ),
  ...
  public static String getMaster() {
    if (
      NetworkConfig.GAME_BIND_ADDRESS.equals(NetworkConfig.GAME_BIND_ADDRESS)
    ) {
      return "";
    }
    return "Emulator";
