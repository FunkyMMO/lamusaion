...
public enum ItemSlot {
  ...
  EARRING_RIGHT_OR_LEFT(
    EARRINGS_LEFT.slotIdMask | EARRINGS_RIGHT.slotIdMask,
    true
  ),
  RING_RIGHT_OR_LEFT(RING_LEFT.slotIdMask | RING_RIGHT.slotIdMask, true),
  SHARD_RIGHT_OR_LEFT(
    POWER_SHARD_LEFT.slotIdMask | POWER_SHARD_RIGHT.slotIdMask,
    true
  ),
  ...
  ADVANCED_STIGMAS(
    ADV_STIGMA1.slotIdMask |
    ADV_STIGMA2.slotIdMask |
    ADV_STIGMA3.slotIdMask |
    ADV_STIGMA4.slotIdMask |
    ADV_STIGMA5.slotIdMask |
    ADV_STIGMA6.slotIdMask,
    true
  ),
  ...
  public static ItemSlot[] getSlotsFor(long slot) {
    ...
    for (ItemSlot itemSlot : values()) {
      if (
        slot != 0 &&
        !itemSlot.isCombo() &&
        (slot & itemSlot.slotIdMask) == itemSlot.slotIdMask
      ) {
        slots.add(itemSlot);
      }
    }
